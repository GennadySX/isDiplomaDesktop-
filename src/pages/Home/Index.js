            ...
            <>
                <div className="container-fluid">
                    <div className="d-sm-flex justify-content-between align-items-center mb-4">
                        ...
                        data-bs-hover-animate="tada" href="#"><i
                                ...
                                <div className="card-body">
                                    <div className="row align-items-center no-gutters">
                                        <div className="col mr-2">
                                            ...
                                            <div className="text-dark font-weight-bold h5 mb-0"><span>$40,000</span>
                                            </div>
                                        </div>
                                ...
                                <div className="card-body">
                                    <div className="row align-items-center no-gutters">
                                        <div className="col mr-2">
                                            ...
                                            <div className="text-dark font-weight-bold h5 mb-0"><span>$215,000</span>
                                            </div>
                                        </div>
                                        <div className="col-auto"><i
                                            ...
                                            <div className="row no-gutters align-items-center">
                                                ...
                                                <div className="col">
                                                    <div className="progress progress-sm">
                                                        <div className="progress-bar bg-info home-1" aria-valuenow="50"
                                                             aria-valuemin="0" aria-valuemax="100" >
                                                            <span className="sr-only">50%</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="dropdown no-arrow">
                                        ...
                                        <div className="dropdown-menu shadow dropdown-menu-right animated--fade-in"
                                            ...
                                            className="dropdown-item" role="presentation" href="#">&nbsp;Another
                                            action</a>
                                            <div className="dropdown-divider"></div>
                                            <a className="dropdown-item" role="presentation" href="#">&nbsp;Something
                                                else here</a></div>
                                    </div>
                                </div>
                                <div className="card-body">
                        ...
                        <div className="col-lg-5 col-xl-4">
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <div
                                        className="text-center small mt-4"><span className="mr-2"><i
                                        className="fas fa-circle text-primary"></i>&nbsp;Direct</span><span
                                        className="mr-2"><i
                                        className="fas fa-circle text-success"></i>&nbsp;Social</span><span
                                        className="mr-2"><i
                            ...
                            <div className="card shadow mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="progress mb-4">
                                        <div className="progress-bar bg-danger home-2" aria-valuenow="20" aria-valuemin="0"
                                    ...
                                    <div className="progress mb-4">
                                        <div className="progress-bar bg-warning home-3" aria-valuenow="40" aria-valuemin="0"
                                             aria-valuemax="100" ><span
                                    ...
                                    <div className="progress mb-4">
                                        <div className="progress-bar bg-primary home-4" aria-valuenow="60" aria-valuemin="0"
                                             aria-valuemax="100" ><span
                                    ...
                                    <div className="progress mb-4">
                                        <div className="progress-bar bg-info home-5" aria-valuenow="80" aria-valuemin="0"
                                             aria-valuemax="100" ><span
                                    ...
                                    <div className="progress mb-4">
                                        <div className="progress-bar bg-success w-100" aria-valuenow="100" aria-valuemin="0"
                                             aria-valuemax="100" ><span
                                ...
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">
                                        <div className="row align-items-center no-gutters">
                                            <div className="col mr-2">
                                                ...
                                                className="text-xs">10:30 AM</span></div>
                                            <div className="col-auto">
                                    ...
                                    <li className="list-group-item">
                                        <div className="row align-items-center no-gutters">
                                            <div className="col mr-2">
                                                <h6 className="mb-0"><strong>Lunch meeting</strong></h6><span
                                                className="text-xs">11:30 AM</span></div>
                                            <div className="col-auto">
                                                <div className="custom-control custom-checkbox"><input
                                                    className="custom-control-input" type="checkbox"
                                    ...
                                    <li className="list-group-item">
                                        <div className="row align-items-center no-gutters">
                                            <div className="col mr-2">
                                                <h6 className="mb-0"><strong>Lunch meeting</strong></h6><span
                                                className="text-xs">12:30 AM</span></div>
                                            <div className="col-auto">
                                                <div className="custom-control custom-checkbox"><input
                                                    className="custom-control-input" type="checkbox"
